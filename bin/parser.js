...
var $0 = $$.length - 1;
switch (yystate) {
case 1: return AST.makeProgram(null,[],this._$); 
break;
case 2: return $$[$0-1]; 
break;
case 3: this.$ = AST.makeNoneType(this._$); 
break;
case 4: this.$ = AST.makeTopType(this._$); 
break;
case 5: this.$ = AST.makePrimitiveType(yytext,this._$); 
break;
case 6: this.$ = AST.makePrimitiveType(yytext,this._$); 
break;
case 7: this.$ = AST.makePrimitiveType(yytext,this._$); 
break;
case 8: this.$ = AST.makeBangType($$[$0],this._$); 
break;
case 9: this.$ = $$[$0]; 
break;
case 10: this.$ = AST.makeRefType($$[$0],this._$); 
break;
case 11: this.$ = $$[$0-1]; 
break;
case 12: this.$ = AST.makeCapabilityType($$[$0-1],$$[$0],this._$); 
break;
case 13: this.$ = AST.makeRecordType([],this._$); 
break;
case 14: this.$ = AST.makeRecordType($$[$0-1],this._$); 
break;
case 15: this.$ = AST.makeTupleType($$[$0-1],this._$); 
break;
case 16: this.$ = AST.makeForallType($$[$0-2],$$[$0],null,this._$); 
break;
case 17: this.$ = AST.makeForallType($$[$0-4],$$[$0],$$[$0-2],this._$); 
break;
case 18: this.$ = AST.makeExistsType($$[$0-2],$$[$0],null,this._$); 
break;
case 19: this.$ = AST.makeExistsType($$[$0-4],$$[$0],$$[$0-2],this._$); 
break;
case 20: this.$ = AST.makeSubstitution($$[$0-5],$$[$0-3],$$[$0-1],this._$); 
break;
case 21: this.$ = AST.makeSumType($$[$0],this._$); 
break;
case 22: this.$ = AST.makeRelyType($$[$0-2],$$[$0],this._$); 
break;
case 23: this.$ = AST.makeGuaranteeType($$[$0-2],$$[$0],this._$); 
break;
case 24: this.$ = AST.makeFunType($$[$0-2],$$[$0],this._$); 
break;
case 25: this.$ = AST.makeDefinitionType($$[$0-3],$$[$0-1],this._$); 
break;
case 26: this.$ = AST.makeStackedType($$[$0-2],$$[$0],this._$); 
break;
case 27: this.$ = AST.makeStarType($$[$0-2],$$[$0],this._$); 
break;
case 28: this.$ = AST.makeIntersectionType($$[$0-2],$$[$0],this._$); 
break;
case 29: this.$ = AST.makeAlternativeType($$[$0-2],$$[$0],this._$); 
break;
case 30: this.$ = [AST.makeTaggedType($$[$0-2],$$[$0],this._$)]; 
break;
case 31: this.$ = [AST.makeTaggedType($$[$0-4],$$[$0-2],this._$)].concat($$[$0]); 
break;
case 32: this.$ = [$$[$0]]; 
break;
case 33: $$[$0-2].push($$[$0]); this.$ = $$[$0-2]; 
break;
case 34: this.$ = AST.makeNameType(yytext,this._$); 
break;
case 35: this.$ = AST.makeFieldType($$[$0-2],$$[$0],this._$); 
break;
case 36: this.$ = [$$[$0]]; 
break;
case 37: this.$ = [$$[$0-2]].concat($$[$0]); 
break;
case 38: this.$ = AST.makeProgram(null,$$[$0],this._$); 
break;
case 39: this.$ = AST.makeProgram($$[$0].typedefs,$$[$0-1].concat($$[$0].exp),this._$); 
break;
case 40: this.$ = $$[$0]; 
break;
case 41: this.$ = AST.makeProgram($$[$0-1],$$[$0],this._$); 
break;
case 42: this.$ = AST.makeProgram($$[$0-2].concat($$[$0].typedefs),$$[$0-1].concat($$[$0].exp),this._$); 
break;
case 43: this.$ = [$$[$0]]; 
break;
case 44: this.$ = [$$[$0-1]].concat($$[$0]); 
break;
case 45: this.$ = AST.makeTypedef($$[$0-2],$$[$0],null,this._$); 
break;
case 46: this.$ = AST.makeTypedef($$[$0-5],$$[$0],$$[$0-3],this._$); 
break;
case 47: this.$ = [$$[$0]]; 
break;
...
break;
case 51: this.$ = [AST.makeForall($$[$0-2],$$[$0][0],null,this._$)]; 
break;
case 52: this.$ = [AST.makeForall($$[$0-4],$$[$0][0],$$[$0-2],this._$)]; 
break;
case 53: this.$ = $$[$0]; 
break;
case 54: this.$ = $$[$0]; 
...
case 55: this.$ = $$[$0]; 
break;
case 56: this.$ = [AST.makeShare(true,$$[$0-4],$$[$0-2],$$[$0],this._$)]; 
break;
case 57: this.$ = [AST.makeShare(false,$$[$0-4],$$[$0-2],$$[$0],this._$)]; 
break;
case 58: this.$ = [AST.makeSubtype(true,$$[$0-2],$$[$0],this._$)]; 
break;
case 59: this.$ = [AST.makeSubtype(false,$$[$0-2],$$[$0],this._$)]; 
break;
case 60: this.$ = [AST.makeEquals(true,$$[$0-2],$$[$0],this._$)]; 
break;
case 61: this.$ = [AST.makeEquals(false,$$[$0-2],$$[$0],this._$)]; 
break;
}
},
