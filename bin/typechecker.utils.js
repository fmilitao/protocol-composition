...
var TypeChecker = (function (exports) {
    ...
    var unifyAux = function (x, t, a, trail) {
        ...
        switch (t.type) {
            ...
            case types.SumType: {
                ...
                if (ts.size !== as.size)
                    return false;
                for (var _i = 0, _a = ts.keys(); _i < _a.length; _i++) {
                    var k = _a[_i];
                    if (!as.has(k) ||
            ...
            case types.RecordType: {
                ...
                if (ts.size !== as.size)
                    return false;
                for (var _b = 0, _c = ts.keys(); _b < _c.length; _b++) {
                    var k = _c[_b];
                    if (!as.has(k) ||
                        !aux(unifyAux(x, ts.get(k), as.get(k), trail)))
                        return false;
    ...
    var shift = function (t, c, d) {
        switch (t.type) {
            ...
            case types.RecordType: {
                ...
                t.fields().forEach(function (value, key) {
        ...
        switch (t1.type) {
            ...
            case types.SumType: {
                ...
                if (t1s.size !== t2s.size)
                    return false;
                for (var _i = 0, _a = t1s.keys(); _i < _a.length; _i++) {
                    var k = _a[_i];
                    if (!t2s.has(k) ||
            ...
            case types.RecordType: {
                ...
                if (t1s.size !== t2s.size)
                    return false;
                for (var _b = 0, _c = t2s.keys(); _b < _c.length; _b++) {
                    var k = _c[_b];
                    if (!t1s.has(k) ||
                        !equalsAux(t1s.get(k), t2s.get(k), trail))
                        return false;
    ...
    var subtypeAux = function (t1, t2, trail) {
        ...
        if (t1.type === types.RecordType && t2.type === types.BangType &&
            ...
            var allPure = true;
            for (var _i = 0, _a = t1fields.keys(); _i < _a.length; _i++) {
                var k = _a[_i];
        ...
        switch (t1.type) {
            ...
            case types.RecordType: {
                ...
                for (var _b = 0, _c = t2fields.keys(); _b < _c.length; _b++) {
                    var k = _c[_b];
                    if (!t1fields.has(k) ||
            ...
            case types.SumType: {
                var i1s = t1.tags();
                var i2s = t2.tags();
                for (var _d = 0, _e = i1s.keys(); _d < _e.length; _d++) {
                    var k = _e[_d];
                    if (!i2s.has(k) ||
    ...
    var isFreeAux = function (x, t, trail) {
        ...
        switch (t.type) {
            ...
            case types.RecordType: {
                var fields = t.fields();
                for (var _i = 0, _a = fields.keys(); _i < _a.length; _i++) {
                    var k = _a[_i];
